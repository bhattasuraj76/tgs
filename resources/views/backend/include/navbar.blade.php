...
<nav class="top-toolbar navbar navbar-mobile navbar-tablet">
    <ul class="navbar-nav nav-left">
        <li class="nav-item">
            <a href="javascript:void(0)" data-toggle-state="aside-left-open">
                <i class="icon dripicons-align-left p-10"></i>
            </a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav nav-right">
        <li class="nav-item">
            <a href="javascript:void(0)" data-toggle-state="mobile-topbar-toggle" class="p-t-5">
                <i class="icon dripicons-dots-3 rotate-90  p-10"></i>
            </a>
        </li>
    </ul>
</nav>
<nav class="top-toolbar navbar navbar-desktop flex-nowrap topheader">
    <ul class="navbar-nav nav-left">
        <li class="nav-item">
            <a href="javascript:void(0)" data-toggle-state="content-menu-close">
                <i class="icon dripicons-align-left pt-20"></i>
            </a>
        </li>
    ...
    <ul class="navbar-nav nav-right">
        <li class="nav-item dropdown">
            <a class="nav-link nav-pill p-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                @php
                $img = $authUser->image ? asset($authUser->image) : asset('public/backend/images/avatars/1.png');
                @endphp
                <img src="{{ $img }}" class="rounded-circle" height="35" width="35" alt="Admin">
            </a>
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                <div class="dropdown-header pb-3">
                    <div class="media d-user">
                        <div class="media-body">
                            <h5 class="mt-0 mb-0">Hello, Admin</h5>
                            <span>{{ $authUser->email}}</span>
                        </div>
                    </div>
                </div>

                <a class="dropdown-item" href="{{ route('admin.password.change') }}"><i class="icon dripicons-gear"></i> Change Password </a>
                <a href="javascript:void(0)" class="dropdown-item" onclick="event.preventDefault();  document.getElementById('logout-form').submit();"><i class="icon dripicons-lock-open"></i> Sign Out</a>
                </a>
