        ...
        <div>
            ...
            <nav class="breadcrumb-wrapper" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add a region</li>
                </ol>
            </nav>
        </div>
        <div>
    ...
    <div class="card">
        ...
        <div class="card-body m-t-20">
            <ul class="nav nav-pills " id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#packages" role="tab" data-toggle="pill">Package</a>
                </li>
                <li class="nav-item">
            ...
            <form action="{{route('admin.region.store')}}" class="" method="POST">
                @csrf
                <div class="tab-content m-t-20">
                    <div role="tabpanel" class="tab-pane active" id="basicinfo">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2">
                                <input type="number" min=1 class="form-control {{ $errors->has('position') ? ' is-invalid' : '' }}" name="position" id="position" value="{{ old('position', 1)}}">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <label class="radio-inline">
                                    <input type="radio" name="status" id="active" value="published" @if(old('status')=='published' ){{"checked"}}@endif>
                                    Active
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="status" id="inactive" value="draft" @if(old('status')=='draft' ){{"checked"}}@endif>
                                    Inactive
                                </label>
                            </div>
                        </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="detail">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 {{ $errors->has('short_description') ? ' is-invalid' : '' }}">
                                <textarea name="short_description" id="short_description" class="form-control texteditor" rows="5">{{ old('short_description')  }}</textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group row">
                    ...
                    <div role="tabpanel" class="tab-pane" id="map">
                        @include('backend.region.map-create')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="banner">
                        @include('backend.region.banner-create')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="media">
                        @include('backend.region.media-create')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="packages">
                        @include('backend.region.package-create')
                    </div>
