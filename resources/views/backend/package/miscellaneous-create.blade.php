      <div class="row">
          ...
          <div class="col-6">
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_family_holiday" id="is_family_holiday" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_trek_hike" id="is_trek_hike" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_extreme_adventure" id="is_extreme_adventure" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_best_of_himalyaya" id="is_best_of_himalyaya" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_luxury_holiday" id="is_luxury_holiday" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_wildlife_safari" id="is_wildlife_safari" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_culture_heritage" id="is_culture_heritage" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_off_the_beaten_path" id="is_off_the_beaten_path" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_active_adventure" id="is_active_adventure" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_ecofriendly_trek" id="is_ecofriendly_trek" value="1">
                      </label>
                  </div>
              </div>
          ...
          <div class="col-6">
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_honeymoon_package" id="is_honeymoon_package" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_photography_tour" id="is_photography_tour" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_student_trip" id="is_student_trip" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_filming_documentary" id="is_filming_documentary" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_gay_lesbian_trek_tour" id="is_gay_lesbian_trek_tour" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_meeting_conference" id="is_meeting_conference" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_festival_tour" id="is_festival_tour" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_bird_watching" id="is_bird_watching" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_last_minute_departure" id="is_last_minute_departure" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_overland_tour" id="is_overland_tour" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_food_tour" id="is_food_tour" value="1">
                      </label>
                  </div>
              </div>
              <hr>
              <div class="form-group row">
                  ...
                  <div class="col-lg-6">
                      <label class="checkbox-inline">
                          <input type="checkbox" name="is_buddha_footstep" id="is_buddha_footstep" value="1">
                      </label>
                  </div>
              </div>
          </div>
