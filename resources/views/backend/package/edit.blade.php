        ...
        <div>
            ...
            <nav class="breadcrumb-wrapper" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit a package</li>
                </ol>
            </nav>
        </div>
        <div>
            ...
            <form method="POST" enctype="multipart/form-data" id="packageForm">
                ...
                <div class="tab-content m-t-30">
                    <div role="tabpanel" class="tab-pane active" id="basicfields">
                        @include('backend.package.package-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="overviews">
                        @include('backend.package.overview-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="media">
                        @include('backend.package.media-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="banner">
                        @include('backend.package.banner-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="photos">
                        @include('backend.package.photos-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="video">
                        @include('backend.package.video-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="services">
                        @include('backend.package.service-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="itenaries">
                        @include('backend.package.itenary-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="datesprice">
                        @include('backend.package.datesprice-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="faqs">
                        @include('backend.package.faq-edit')
                    </div>
                    <div role="tabpanel" class="tab-pane" id="miscellaneous">
                        @include('backend.package.miscellaneous-edit')
                    </div>
...
<script src="{{asset('public/backend/js/packagedatesprice.js')}}"></script>
