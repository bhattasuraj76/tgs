    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input type="text" name="image_alt" class="form-control" id="image_alt" value="{{ old('image_alt') }}">
        </div>
    </div>
    <!-- feature image end -->
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            <input type="text" name="thumbnail_alt" class="form-control" id="thumbnail_alt">
        </div>
    </div>
